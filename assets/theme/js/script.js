    ...
    a.fn.jarallax &&
      ...
      e
        ...
        a(document).on("changeParameter.cards", function (b, d, e, g) {
          if ("bg" === d)
            switch (
              (a(b.target).jarallax("destroy").css("position", ""), g)
            ) {
            case "type":
    ...
    a(window).scroll(function () {
      ...
      if (k) {
        ...
        c
          ? d != k.fixed &&
            (h
              ? ((k.fixed = d), a(k.elm).toggleClass("is-fixed"))
              : (n = setTimeout(function () {
                k.fixed = d;
                a(k.elm).toggleClass("is-fixed");
              }, 40)))
          : ((k.fixed = !1), a(k.elm).removeClass("is-fixed"));
      }
    });
    ...
    a(document).ready(function () {
      if (!a.isMobile() && a("input[name=animation]").length) {
        var b = function (a) {
            ...
            if (
              b.find(".carousel-item.active .hidden.animate__animated").lenght
            )
              return !1;
  ...
  a(document).ready(function () {
    if (a(".mbr-arrow-up").length) {
      ...
      d.scroll(function () {
        ...
        a(this).scrollTop() > c / 2 - document.documentElement.clientHeight / 2
          ? b.fadeIn()
          : b.fadeOut();
      });
      b.click(function () {
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.innerHTML =
      "<a href=\"https://mobirise.in\">mobirise.com</a> Mobirise v5.2.0";
